...
如果被 ban 了你可以不需要使用停止计费指令 短时间内你可以直接随意修改 Minecraft 名字， 然后再直接重新进入便可继续进行~~享受~~(飘)，但是请一定注意此功能只有EU加速拥有，Hypixel 加速服务依然需要更换新的IP,请不要因为没有换IP而被suspicious activity ban而骚扰staff.
